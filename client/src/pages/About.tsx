        ...
        <div className="eats-container">
          ...
          <div className="team-img">
            ...
            <p>
              ...
              have experience in using React, SQL, JS, NPM, and CSS.<br></br>
              Fitness is a significant part of my life, and I am a regular
              gym-goer at Los Campeones. Additionally, I’m a horror movie enthusiast, and a couple of my
              favorites include the Babadook and Hereditary.
            </p>
          </div>
        </div>
      </section>
